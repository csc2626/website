...
![](images/robot1.png){width="250"} ![](images/robot2.png){width="200"} 
...
![](images/robot1.png){width="250"} ![](images/robot2.png){width="200"} {{< video https://www.youtube.com/watch?v=eRwTbRtnT1I?rel=0&enablejsapi=1 width="300" height="200" >}} {{< video https://www.youtube.com/watch?v=VfDYUeyzHqc?rel=0&enablejsapi=1 width="200" height="200" >}}
