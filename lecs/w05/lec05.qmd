...
* IRL reduces the imitation problem to:
    + **Recovering a reward function** given a set of
    demonstrations.
    + Solving the MDP using RL to recover the
    policy, conditioned on our learned reward.
...
* Applying the principle of maximum entropy **breaks the ambiguity of the reward
function.**

* Leads us to a distribution over behaviors constrained to match feature expectations of the demonstrations while **having no preference to any particular
path that fits this constraint.**
...
* Baselines:
    ...
    + **Action-based** [Ramachandran et al. 2007, Neu et al. 2007]: The choice of an action is distributed according to the future expected reward of the best policy after taking that action.
    Suffers from label bias (local distribution of probability mass):
...
:::{.green}
* Solves the reward ambiguity problem by applying the Maximum Entropy
theorem, i.e. using path distributions in the exponential family
...
:::{.column width="25%" .red-annotation}
**Problem #1:** \
...
:::{.fragment .absolute bottom=0 left=0 .small-math}
For more info see: \
...
:::{.red-annotation .absolute bottom=40 right=80}
...
:::{.red-annotation .absolute right=0 bottom=50% .right-align}
Arbitrary differentiable functions $c$, $f$ 
...
![](images/guided-policy1.png)

:::{.absolute bottom=200 left=0 .fragment}

![](images/guided-policy2.png)
:::

::: {.absolute bottom=0 left=0 .fragment}

![](images/guided-policy3.png)
:::

::: {.absolute bottom=0 right=0 .fragment}

![](images/guided-policy4.png){width=550}
:::
...
{{< video https://www.youtube.com/watch?v=hXxaepw0zAw&ab_channel=RAIL width="800" height="550" >}}
...
{{< video https://rss2017.lids.mit.edu/static/slides/04.mp4 width="800" height="550" >}}
...
{{< video https://www.youtube.com/watch?v=xCXx09gfhx4&t=3s width="90%" height="90%" >}}
