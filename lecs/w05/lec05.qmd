...
::: {.absolute .fragment bottom="200" left="0"}
![](images/guided-policy2.png)
:::

::: {.absolute .fragment bottom="0" left="0"}
![](images/guided-policy3.png)
:::

::: {.absolute .fragment bottom="0" right="0"}
...
{{< video https://www.youtube.com/watch?v=xCXx09gfhx4&t=3s?rel=0&enablejsapi=1 width="90%" height="90%" >}}
