...
{{< video https://www.youtube.com/watch?v=wjnhrzugBj4 width="100%" height="75%" >}}


##

{{< video https://www.youtube.com/watch?v=Wvh-uixQrGI&t=1s width="100%" height="75%" >}}
...
![](images/teleportation1.jpg){width="30%"}
![](images/teleporation2.jpg){width="30%" height=200}
![](images/teleporation3.jpg){width="30%" height=200}

![](images/teleporation4.jpg){width="30%"}
![](images/teleporation5.jpg){width="30%"}
![](images/teleporation6.jpg){width="30%" height=200}
...
![](images/autonomous-assistance.png)
**Autonomous Assistance**
...
![](images/acheive-goal-number.png)
**Achieve Goal**
...
:::{.absolute bottom=200 right=0 .small-math}
Deterministic \
problem for \
each future
:::
...
![](images/unpredictable.gif){fig-align="center" height=450}
