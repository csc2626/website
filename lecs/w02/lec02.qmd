...
::: {.column width="40%" .red-annotation .fragment .fade-in-then-out}
...
$2Ru + 2B^T P_0 Ax + 2B^T P_0 Bu = \mathbf{0}$
$(R + B^T P_0 B)\mathbf{u} = -B^T P_0 Ax$
...
::: {.column width="40%" .fragment .fade-out}
...
::: {.column width="40%" .red-annotation .fragment}
...
:::
::: {.column width="60%" .red-annotation .fragment fragment-index=3}
...
::: {.column width="40%" .red-annotation .fragment fragment-index=1 }
...
::: {.column width="30%" .red-annotation .fragment fragment-index=2}
...
:::{.small-math}
Redefine state:
$z_{t+1} = \begin{bmatrix} \bar{x}_{t+1} \\ 1 \end{bmatrix} = \begin{bmatrix} A & c \\ 0 & 1 \end{bmatrix} \begin{bmatrix} \bar{x}_t \\ 1 \end{bmatrix} + \begin{bmatrix} B \\ 0 \end{bmatrix} u_t = \bar{A} z_t + \bar{B} u_t$
:::
