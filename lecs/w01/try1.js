...
(function() {
    ...
    function createCurtain(iframe) {
        const allCurtain = document.querySelectorAll('section.present .curtain');
    ...
    function setupCurtainForIframe(iframe) {
        ...
        // console.log(`Setting up curtain for iframe: ${iframeId}`);
        ...
        console.log(`Curtain created for iframe: ${iframeId}`);
    ...
    function handleSlideChange() {
        ...
        console.log('In handleslide change');
