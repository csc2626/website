...
::: {.column width="30%" .red-annotation .fragment}
<br> 
...
{{< video https://www.youtube.com/watch?v=M8r0gmQXm1Y width="400" height="300" >}}
...
::: {.column width="40%"}
{{< video https://www.youtube.com/watch?v=Q3LXJGha7Ws width="400" height="300" >}}
...
::: {.column width="40%"}
{{< video https://www.youtube.com/watch?v=RjGe0GiiFzw width="400" height="300" >}}
...
::: {.column width="45%"}
{{< video https://www.youtube.com/watch?v=0XdC1HUp-rU width="400" height="300" >}}
...
:::: {.columns}
::: {.column width="33%" .small-math}
{{< video https://www.youtube.com/watch?v=I39sxwYKlEE width="500" height="200" >}}
...
::: {.column width="33%" .small-math}
{{< video https://www.youtube.com/watch?v=2KMAAmkz9go start="2:02" width="500" height="200" >}}
...
::: {.column width="33%" .small-math}
{{< video https://www.youtube.com/watch?v=ilP4aPDTBPE width="500" height="200" >}}
...
{{< video https://www.youtube.com/watch?v=qhUvQiKec2U width="700" height="400" >}}
...
:::{.absolute top=90 left=300 .red-annotation}
...
:::: {.columns}
::: {.column width="50%"}
{{< video https://www.youtube.com/watch?v=_ZdBfU4xJnQ width="400" height="300" >}}
[<https://www.youtube.com/watch?v=_ZdBfU4xJnQ>]{.small-math}
:::

::: {.column width="50%"}
{{< video https://www.youtube.com/watch?v=9dN0wwXDuqo width="400" height="300" >}}
[<https://www.youtube.com/watch?v=9dN0wwXDuqo>]{.small-math}
:::
::::
...
:::: {.columns}
::: {.column width="50%" .small-math .fragment}
...
{{< video https://www.youtube.com/watch?v=V00npNnWzSU width="300" height="200" >}}
...
{{< video https://www.youtube.com/watch?v=hNsP6-K3Hn4 width="700" height="400" >}}
...
## [Is the quadratic regret in horizon unavoidable for behavioral cloning? [No]{style="color:red;"}]{style="font-size:0.8em;"}
...
::: {.red-annotation style="text-align:right;" .fragment}
...
:::{style="text-align:center;" .fragment fragment-index=5}
...
::: {.column width="40%" .red-annotation}
