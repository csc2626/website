...
|  |  | Making cost-to-go queries to experts | 📖 | [🖥️](/lecs/w04/lec04.html){.no-style target="_blank" aria-label="Lec 4 slides"} | 📋 |  |  |
|  |  | Expert iteration | 📖 | 🖥️ | 📋 |  |  |
...
|  |  | No lecture |  |  |  |  |  |
|  |  | No office hours |  |  |  |  |  |
| [9](#week-9) | Mon, Nov 4 | Adversarial imitation learning | 📖 | 🖥️ | 📋 |  |  |
